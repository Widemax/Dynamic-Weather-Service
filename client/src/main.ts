...
const fetchWeather = async (cityName: string) => {
  const response = await fetch('/api/weather/', {
    ...
    // Fix: Use "city" instead of "cityName" to match the server expectation
  ...
  // Fix: Access weatherData.current and weatherData.forecast directly
...
const renderSearchHistory = async (searchHistory: any) => {
  ...
  if (searchHistoryContainer) {
    ...
    // Display most recent searches at the top.
